...
public class CucumberAssert extends Assert {

	/**
	 * Protect constructor since it is a static only class
	 */
	protected CucumberAssert() {
	}
	...
	static public void fail(String message) {
		...
		BaseDriver.captureScreenshot("CucumberAssertError");
		if (message == null) {
			throw new AssertionError();
			// Log.error("AssertError["+message+"]");
		}
	...
	static public void assertEquals(String message, Object expected,
		...
		if (equalsRegardingNull(expected, actual)) {
			...
			// failNotEquals(cleanMessage, (String) expected, (String) actual);
		} else {
	 ...
	 * {@link AssertionError} is thrown with the given message. If
	 * <code>first</code> and <code>second</code> are <code>null</code>, they
	 * are considered equal.
	 *
	 * @param message
	 *            the identifying message for the {@link AssertionError} (
	...
	/**
	 * Asserts that two objects are <b>not</b> equals. If they are, an
	 * {@link AssertionError} without a message is thrown. If <code>first</code>
	 * and <code>second</code> are <code>null</code>, they are considered equal.
	 *
	 * @param first
	 *            first value to check
	 * @param second
	...
	/**
	 * Asserts that two doubles or floats are <b>not</b> equal to within a
	 * positive delta. If they are, an {@link AssertionError} is thrown with the
	 * given message. If the expected value is infinity then the delta value is
	...
	/**
	 * Asserts that two doubles or floats are <b>not</b> equal to within a
	 * positive delta. If they are, an {@link AssertionError} is thrown. If the
	 * expected value is infinity then the delta value is ignored.NaNs are
	 * considered equal: <code>assertNotEquals(Double.NaN, Double.NaN, *)</code>
	 * fails
	 *
	 * @param first
	 *            first value to check
