...
/**
 * ClassName:TimeUtils Function: TODO ADD FUNCTION. Reason: TODO ADD REASON.
...
public class TimeUtils {
	...
	public static String howManySeconds(long startseconds) {
		...
		String totalseconds = String.format(
				"%02dm %02ds",
				TimeUnit.MILLISECONDS.toMinutes(millonseconds),
				TimeUnit.MILLISECONDS.toSeconds(millonseconds)
						- TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS
								.toMinutes(millonseconds)));
		/*
		 * int seconds = (int) (millonseconds / 1000) % 60 ; int minutes = (int)
		 * ((millonseconds / (1000*60)) % 60);
		 * 
		 * String totalseconds=String.format("%02dm %02ds",minutes,seconds);
		 */
	...
	/*
	 * public static void main(String[] args) { String howManySeconds =
	 * howManySeconds(System.currentTimeMillis());
	 * 
	 * }
	 */
	/**
	...
	public static String howManyMinutes(String starttime, String endtime) {
		...
		logger.debug("the start time is:" + starttime + ",the end time is:"
				+ endtime);
		long millonseconds = endseconds - startseconds;
		String totalminutes = String.valueOf(millonseconds / (1000 * 60))
				+ " Minute(s)";
		if (totalminutes.equals("0 Minute(s)")) {
			totalminutes = String.valueOf(millonseconds / 1000) + " Seconds";
		}
	...
	public static List<String> getCurrentWeekDays() {
		...
		for (int kindex = 1; kindex <= 7; kindex++) {
			...
			String currentday = new SimpleDateFormat("yyyy-MM-dd").format(c
					.getTime());
