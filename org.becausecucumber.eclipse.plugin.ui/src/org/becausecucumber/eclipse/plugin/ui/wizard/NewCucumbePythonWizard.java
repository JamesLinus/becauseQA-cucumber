...
public class NewCucumbePythonWizard extends Wizard implements INewWizard, IExecutableExtension {
	...
	public NewCucumbePythonWizard() {
		// TODO Auto-generated constructor stub
		setWindowTitle("Python Cucumber Project");
	}
	...
	public void addPages() {
		...
		_pageOne.setTitle("New Python Project for Cucumber(Still In Development...)");
		_pageOne.setDescription("Create Python project from cucumber.");
