...
public class NewCucumbeCSWizard extends Wizard implements INewWizard, IExecutableExtension {
	...
	public NewCucumbeCSWizard() {
		// TODO Auto-generated constructor stub
		setWindowTitle("C# Cucumber Project");
	}
	...
	public void addPages() {
		...
		_pageOne.setTitle("New C# Project for Cucumber(Still In Development...)");
		_pageOne.setDescription("Create C# project from cucumber.");
