...
public class NewCucumbeGroovyWizard extends Wizard implements INewWizard, IExecutableExtension {
	/*
	 * refer this url:
	...
	public NewCucumbeGroovyWizard() {
		// TODO Auto-generated constructor stub
		setWindowTitle("Groovy Cucumber Project");
	}
	...
	public void addPages() {
		...
		_pageOne.setTitle("New Groovy Project for Cucumber(Still In Development...)");
		_pageOne.setDescription("Create Groovy project from cucumber.");
