...
public class ExceptionUtil {
	...
	public static IStatus status(int severity, String msg) {
		return new Status(severity, CucumberPeopleActivator.ORG_CUCUMBERPEOPLE_ECLIPSE_PLUGIN_CUCUMBER, msg);
	}
	...
	public static IStatus status(int severity, Throwable e) {
		...
		return new Status(severity, CucumberPeopleActivator.ORG_CUCUMBERPEOPLE_ECLIPSE_PLUGIN_CUCUMBER, getMessage(e),
				e);
	}
