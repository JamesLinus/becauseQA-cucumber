...
/**
 * An abstract super class to more easily create preferences pages composed of
 * modular sections. Each section encapsulates its own widgetry and validation
 * logic.
 * 
 * @author Kris De Volder
 */
public abstract class PreferencePageWithSections extends PreferencePage
		implements IWorkbenchPreferencePage, ValueListener<ValidationResult>, IPageWithSections {
