...
/**
 * A composite validator 'composes' the results of multiple validator by
 * computing each in order and only returning the worst result. If some results
 * are equal in terms of status priority then the first one is returned.
 * 
