...
import static org.becausecucumber.eclipse.plugin.ui.preference.searcherPage.QuickSearchPreferences.IGNORED_EXTENSIONS;
import static org.becausecucumber.eclipse.plugin.ui.preference.searcherPage.QuickSearchPreferences.IGNORED_NAMES;
import static org.becausecucumber.eclipse.plugin.ui.preference.searcherPage.QuickSearchPreferences.IGNORED_PREFIXES;

import org.becausecucumber.eclipse.plugin.common.searcher.priority.DefaultPriorityFunction;
...
public class QuickSearchIgnoreSection extends PrefsPageSection {
	...
	private static final String[] prefsKeys = { IGNORED_EXTENSIONS, IGNORED_PREFIXES, IGNORED_NAMES };

	private static final String[] fieldNames = { "Extensions", "Prefixes", "Names" };
	...
	public QuickSearchIgnoreSection(PreferencePageWithSections owner) {
		super(owner);
		prefs = CucumberPeopleActivator.getPreferences();
		prefsStore = prefs.getStore();

		String[] defaultIgnores = { withSeparator(", ", defaultPriorityFun.ignoredExtensions),
		...
		this.group = new PrefsGroupSection(owner, "Ignore Cucumber Step Defination Settings", fields);
	}
	...
	private class IgnoreListField extends PrefsPageSection {
		private static final int HEIGHT_HINT = 40; // TODO: compute based on
													// font size. 3 / 4 lines of
													// text
		...
		public IgnoreListField(PreferencePageWithSections owner, String labelText, String prefsKey, String defaultValue,
				String tooltip) {
			super(owner);
		...
		public void createContents(Composite parent) {
			...
			grabHorizontal.hint(SWT.DEFAULT, HEIGHT_HINT).indent(FIELD_INDENT, 0).applyTo(text);
