...
public class QuickSearchPreferences {
	...
	/**
	 * Takes a raw string list as entered in the prefs page input field and
	 * parses it.
	 * <p>
	 * Commas and newline are treated as 'separators' between elements. Further,
	 * any trailing and leading whitespace is stripped from individual elements
	 * and empty strings are silently dropped.
	 */
