...
/**
 * A composite PrefsPageSection that wraps its subsections inside a Group
...
public class PrefsGroupSection extends PrefsPageSection {
	...
	/**
	 * The validator for the Group is a composite of the validators for each
	 * section.
	 */
	...
	/**
	 * Setting isVisible to false will make this group disappear. Setting it to
	 * true will make it re-appear.
	 */
