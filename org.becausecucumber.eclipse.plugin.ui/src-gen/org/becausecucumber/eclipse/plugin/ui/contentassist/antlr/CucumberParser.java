 ...
 * generated by Xtext
 */
package org.becausecucumber.eclipse.plugin.ui.contentassist.antlr;
...
public class CucumberParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.becausecucumber.eclipse.plugin.ui.contentassist.antlr.internal.InternalCucumberParser createParser() {
		org.becausecucumber.eclipse.plugin.ui.contentassist.antlr.internal.InternalCucumberParser result = new org.becausecucumber.eclipse.plugin.ui.contentassist.antlr.internal.InternalCucumberParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStepAccess().getKeywordAssignment_0(), "rule__Step__KeywordAssignment_0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.becausecucumber.eclipse.plugin.ui.contentassist.antlr.internal.InternalCucumberParser typedParser = (org.becausecucumber.eclipse.plugin.ui.contentassist.antlr.internal.InternalCucumberParser) parser;
