...
public class InternalCucumberLexer extends Lexer {
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1106:10: ( ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
            // InternalCucumber.g:1106:12: ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )?
            {
            // InternalCucumber.g:1106:12: ( '-' )?
            int alt1=2;
            ...
            // InternalCucumber.g:1106:17: ( '0' .. '9' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalCucumber.g:1106:18: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            // InternalCucumber.g:1106:29: ( '.' ( '0' .. '9' )+ )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalCucumber.g:1106:30: '.' ( '0' .. '9' )+
                    {
                    match('.'); 
                    // InternalCucumber.g:1106:34: ( '0' .. '9' )+
                    int cnt3=0;
                    loop3:
                    do {
                        int alt3=2;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // InternalCucumber.g:1106:35: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_STEP_KEYWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1108:19: ( ( 'Given' | 'When' | 'Then' | 'And' | 'But' ) ( ' ' | '\\t' )+ )
            // InternalCucumber.g:1108:21: ( 'Given' | 'When' | 'Then' | 'And' | 'But' ) ( ' ' | '\\t' )+
            {
            // InternalCucumber.g:1108:21: ( 'Given' | 'When' | 'Then' | 'And' | 'But' )
            int alt5=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt5) {
                case 1 :
                    // InternalCucumber.g:1108:22: 'Given'
                    {
                    match("Given"); 
                    ...
                    break;
                case 2 :
                    // InternalCucumber.g:1108:30: 'When'
                    {
                    match("When"); 
                    ...
                    break;
                case 3 :
                    // InternalCucumber.g:1108:37: 'Then'
                    {
                    match("Then"); 
                    ...
                    break;
                case 4 :
                    // InternalCucumber.g:1108:44: 'And'
                    {
                    match("And"); 
                    ...
                    break;
                case 5 :
                    // InternalCucumber.g:1108:50: 'But'
                    {
                    match("But"); 
    ...
    public final void mRULE_PLACEHOLDER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1110:18: ( '<' (~ ( ( '>' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+ '>' )
            // InternalCucumber.g:1110:20: '<' (~ ( ( '>' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+ '>'
            {
            match('<'); 
            // InternalCucumber.g:1110:24: (~ ( ( '>' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            int cnt7=0;
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_TABLE_ROW() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1112:16: ( '|' ( (~ ( ( '|' | '\\n' | '\\r' ) ) )* '|' )+ ( ' ' | '\\t' )* RULE_NL )
            // InternalCucumber.g:1112:18: '|' ( (~ ( ( '|' | '\\n' | '\\r' ) ) )* '|' )+ ( ' ' | '\\t' )* RULE_NL
            {
            match('|'); 
            // InternalCucumber.g:1112:22: ( (~ ( ( '|' | '\\n' | '\\r' ) ) )* '|' )+
            int cnt9=0;
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_DOC_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1114:17: ( ( '\"\"\"' ( options {greedy=false; } : . )* '\"\"\"' | '\\'\\'\\'' ( options {greedy=false; } : . )* '\\'\\'\\'' ) RULE_NL )
            // InternalCucumber.g:1114:19: ( '\"\"\"' ( options {greedy=false; } : . )* '\"\"\"' | '\\'\\'\\'' ( options {greedy=false; } : . )* '\\'\\'\\'' ) RULE_NL
            {
            // InternalCucumber.g:1114:19: ( '\"\"\"' ( options {greedy=false; } : . )* '\"\"\"' | '\\'\\'\\'' ( options {greedy=false; } : . )* '\\'\\'\\'' )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalCucumber.g:1114:20: '\"\"\"' ( options {greedy=false; } : . )* '\"\"\"'
                    {
                    match("\"\"\""); 

                    // InternalCucumber.g:1114:26: ( options {greedy=false; } : . )*
                    loop11:
                    do {
                        int alt11=2;
                    ...
                    break;
                case 2 :
                    // InternalCucumber.g:1114:64: '\\'\\'\\'' ( options {greedy=false; } : . )* '\\'\\'\\''
                    {
                    match("'''"); 

                    // InternalCucumber.g:1114:73: ( options {greedy=false; } : . )*
                    loop12:
                    do {
                        int alt12=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1116:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' | '\\r' | '\\n' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) )* '\\'' ) )
            // InternalCucumber.g:1116:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' | '\\r' | '\\n' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) )* '\\'' )
            {
            // InternalCucumber.g:1116:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' | '\\r' | '\\n' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) )* '\\'' )
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // InternalCucumber.g:1116:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' | '\\r' | '\\n' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalCucumber.g:1116:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' | '\\r' | '\\n' ) ) )*
                    loop14:
                    do {
                        int alt14=3;
                        ...
                        switch (alt14) {
                    	case 1 :
                    	    // InternalCucumber.g:1116:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    ...
                    break;
                case 2 :
                    // InternalCucumber.g:1116:96: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalCucumber.g:1116:101: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) )*
                    loop15:
                    do {
                        int alt15=3;
                        ...
                        switch (alt15) {
                    	case 1 :
                    	    // InternalCucumber.g:1116:102: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1118:17: ( '#' (~ ( ( '\\n' | '\\r' ) ) )* RULE_NL )
            // InternalCucumber.g:1118:19: '#' (~ ( ( '\\n' | '\\r' ) ) )* RULE_NL
            {
            match('#'); 
            // InternalCucumber.g:1118:23: (~ ( ( '\\n' | '\\r' ) ) )*
            loop17:
            do {
                int alt17=2;
    ...
    public final void mRULE_TAGNAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1120:14: ( '@' (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )+ )
            // InternalCucumber.g:1120:16: '@' (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            {
            match('@'); 
            // InternalCucumber.g:1120:20: (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            int cnt18=0;
            loop18:
            do {
                int alt18=2;
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1122:11: (~ ( ( '@' | '|' | ' ' | '\\t' | '\\n' | '\\r' ) ) (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )* )
            // InternalCucumber.g:1122:13: ~ ( ( '@' | '|' | ' ' | '\\t' | '\\n' | '\\r' ) ) (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )*
            {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1124:9: ( ( ' ' | '\\t' ) )
            // InternalCucumber.g:1124:11: ( ' ' | '\\t' )
            {
            if ( input.LA(1)=='\t'||input.LA(1)==' ' ) {
                input.consume();
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:1126:10: ( RULE_NL )
            // InternalCucumber.g:1126:12: RULE_NL
            {
            mRULE_NL(); 
    ...
    public final void mRULE_NL() throws RecognitionException {
        try {
            // InternalCucumber.g:1128:18: ( ( '\\r' )? ( '\\n' )? )
            // InternalCucumber.g:1128:20: ( '\\r' )? ( '\\n' )?
            {
            // InternalCucumber.g:1128:20: ( '\\r' )?
            int alt20=2;
