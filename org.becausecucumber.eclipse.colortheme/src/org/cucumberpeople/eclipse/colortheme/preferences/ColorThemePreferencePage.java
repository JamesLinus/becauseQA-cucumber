...
import org.cucumberpeople.eclipse.colortheme.ColorTheme;
import org.cucumberpeople.eclipse.colortheme.ColorThemeManager;
...
public class ColorThemePreferencePage extends PreferencePage
    ...
    private void reloadThemeSelectionList() {
        ...
        fillThemeSelectionList();
        themeSelectionList.setSelection(new String[]{"Roboticket"});
        updateDetails(null);
        container.pack();
    }
}
