package org.cucumberpeople.eclipse.colortheme;
...
public class ColorThemeKeys {
    ...
    public static final String SEARCH_RESULT_INDICATION =
        "searchResultIndication";
    public static final String FILTERED_SEARCH_RESULT_INDICATION =
            "filteredSearchResultIndication";
    public static final String OCCURRENCE_INDICATION = "occurrenceIndication";
    public static final String WRITE_OCCURRENCE_INDICATION =
    ...
    public static final String SOURCE_HOVER_BACKGROUND =
